...
export default function Footer() {
  return (
    <>
        <div className='bg-[#3c2b20] text-white grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
            <div className='ml-4'>
        ...
        <div className='h-20 bg-[#3c2b20] text-white text-xl flex justify-center items-center'>
